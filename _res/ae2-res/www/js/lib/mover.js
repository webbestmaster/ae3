(function(win, doc, $) {
    ...
    Mover.prototype = {
        ...
        onUp: function(e) {
            ...
            if (events.events.length === 0 && isTouch && this.get('pinchIsActive')) {
                // 2 fingers -> 0 finger
                this.set('pinchIsActive', false);
            ...
            if (events.events.length === 0 || !isTouch) {
                // if is not touch device - stop moving
            ...
            if (events.events.length === 1 && isTouch) {
                // 2 fingers -> 1 finger
                this.set('pinchIsActive', false);
                this.setContainerSize();
                this.onDown(e);
        ...
        getPinchData: function(events) {
            ...
            before =
                Math.pow(startEvents[0].x - startEvents[1].x, 2) + Math.pow(startEvents[0].y - startEvents[1].y, 2);
        ...
        setStyleByXYZS: function(xyzs) {
            ...
            $container
                ...
                .css(
                    pre + 'transform',
                    'translate3d(' + xyzs.x + 'px, ' + xyzs.y + 'px, ' + xyzs.z + 'px) scale(' + xyzs.scale + ')'
                );
        },

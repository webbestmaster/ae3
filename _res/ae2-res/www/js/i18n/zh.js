    ...
    APP.languages.zh = {
        ...
        helpList: [
            // 0
            {
                ...
                text: [
                    '要选择一个单位请单击 (<img src="img/help/tap-finger.png" class="icon-in-text" />) 该单位。',
                    '<img src="img/help/finger-on-red-square.png" class="icon-in-text" /> - 红色的区域是一个单位可以移动的范围。',
                    '一个单位可以移动的范围由它的兵种属性和地形共同决定。'
                ]
            },
            // 1
            {
                ...
                text: [
                    '想攻击一个敌方单位，将你的单位移动到他的附近并点选 \'攻击\' <img src="img/help/attack-icon.png" class="icon-in-text" />。',
                    '如果范围内有不止一个目标，你需要选取进攻的对象。进攻的效果取决于单位的能力和地形。'
                ]
            },
            // 2
            {
                ...
                text: [
                    '只有指挥官可以占据一座城堡 (<img src="img/help/occupy-building-icon.png" class="icon-in-text" />)。',
                    '一旦城堡被占用，你可以购买新的单位，你的黄金。',
                    '指挥官并不需要留在城堡以购买单位。'
                ]
            },
            // 3
            {
                ...
                text: [
                    '您可以通过移动一个士兵或指挥官到它，选择占据建筑\'占据\' (<img src="img/help/occupy-building-icon.png" class="icon-in-text" />)。',
                    '一旦建筑物被占用，它会改变颜色。',
                    '如果建筑物被损坏，你必须修复的建筑可占据前(<img src="img/help/fix-building-icon.png" class="icon-in-text" />)。'
                ]
            },
            // 4
            {
                ...
                text: [
                    '一个法师必须从阵亡单位的坟墓召唤骷髅战士的力量。',
                    '后一个单元被击败，墓碑出现1回合。',
                    '将旁边的一个墓碑一个法师，然后选择\'加薪\' <img src="img/help/attack-icon.png" class="icon-in-text" />。'
                ]
            }
        ],
        unitsList: {
            ...
            sorceress: {
                name: '女巫',
                description:
                    '钻研着神秘的黑魔法，虽然对于近身战斗并不擅长，女巫却可以从墓碑中召唤出可怕的骷髅战士来改变战局。'
            },
            wisp: {
                name: '小精灵',
            ...
            catapult: {
                name: '投石车',
                description:
                    '投石车有着长远的射程和恐怖的破坏力，然而这样的优势却也有着相当大的代价，那就是移动与攻击不能并存。他们可以破坏你的建筑来阻止你获得金币，要小心了。'
            },
            dragon: {
                name: '龙',
                description:
                    '这种传奇的生物一直都生活在世界的顶端，他们的吐息对于任何生物来说都是一种灾难，他们的翅膀也帮助他们可以在各种地形上高速移动。'
            },
            skeleton: {
                name: '骷髅',
                description:
                    '被女巫从墓碑中召唤出来，这种不死的生物对于死亡没有任何的恐惧，尽管战斗力不如生前，他们依然是战场上不可忽视的力量。'
            },
            galamar: {
                name: '格拉玛',
                description:
                    '格拉玛 (指挥官) 在攻防两端都有着优异的能力，是军队的核心与领袖。 当被击败后，指挥官也可以在城堡中被复活。游戏的每一种势力都有对应的指挥官。'
            },
            valadorn: {
                name: '渥拉顿',
                description:
                    '渥拉顿 (指挥官)在攻防两端都有着优异的能力，是军队的核心与领袖。 当被击败后，指挥官也可以在城堡中被复活。游戏的每一种势力都有对应的指挥官。'
            },
            'demon-lord': {
                name: '恶魔领主',
                description:
                    '恶魔领主 (指挥官)在攻防两端都有着优异的能力，是军队的核心与领袖。 当被击败后，指挥官也可以在城堡中被复活。游戏的每一种势力都有对应的指挥官。'
            },
            saeth: {
                name: '西斯',
                description:
                    '西斯 (指挥官)在攻防两端都有着优异的能力，是军队的核心与领袖。 当被击败后，指挥官也可以在城堡中被复活。游戏的每一种势力都有对应的指挥官。'
            },
            crystal: {
                name: '水晶',
                description:
                    '从远古遗迹中被发现的水晶，具备着神秘的能量，正义的人认为他象征着守护，而邪恶的人则利用他实施毁灭。'
            }
        },

    ...
    APP.languages.es = {
        ...
        helpList: [
            // 0
            {
                ...
                text: [
                    'Para seleccionar una unidad toca (<img src="img/help/tap-finger.png" class="icon-in-text" />) a la unidad.',
                    '<img src="img/help/finger-on-red-square.png" class="icon-in-text" /> - Los cuadros rojos marcan el rango de movimiento de la unidad.',
                    'El rango de la unidad está determinado por su tipo y el terreno en el que se encuentre.'
                ]
            },
            // 1
            {
                ...
                text: [
                    'Para atacar a una unidad enemiga, mueve tu unidad dentro del rango y selecciona <img src="img/help/attack-icon.png" class="icon-in-text" />.',
                    'Si hay más de un enemigo en rango, selecciona que unidad atacar. El éxito de tu ataque está determinado por las caracteristicas de tu unidad y el terreno.'
                ]
            },
            // 2
            {
                ...
                text: [
                    'Sólo un Comandante puede ocupar (<img src="img/help/occupy-building-icon.png" class="icon-in-text" />) un castillo.',
                    'Una vez que un castillo es ocupado puedes reclutar nuevas unidades con tu oro.',
                    'El Comandante no necesita permanecer en el castillo para reclutar unidades.'
                ]
            },
            // 3
            {
                ...
                text: [
                    'Puedes ocupar edificios moviendo a un soldado o comandante dentro de ellos y seleccionando \'ocupar\' (<img src="img/help/occupy-building-icon.png" class="icon-in-text" />).',
                    'Una vez un edificio es ocupado, cambia su color.',
                    'Si un edificio es dañado tendrás que repararlo (<img src="img/help/fix-building-icon.png" class="icon-in-text" />) antes de que pueda ser ocupado.'
                ]
            },
            // 4
            {
        ...
        unitsList: {
            soldier: {
                name: 'Soldado',
                description:
                    'Los soldados son sólidos y completos guerreros que forman la columna vertebral de cualquier ejército. Los soldados son también la unica unidad que puede capturar edificios para obtener oro.'
            },
            archer: {
                name: 'Arquero',
                description:
                    'Con sus poderosos arcos los arqueros puede atacar desde la distancia y son especialmente poderosos contra enemigos voladores.'
            },
            elemental: {
                name: 'Elemental',
                description:
                    'Los elementales son espíritus magicos del agua. Cuando están en el agua, los elementales tienen un mayor movimiento y una defensa aumentada.'
            },
            sorceress: {
                name: 'Hechicera',
                description:
                    'Habilidosa en el uso de la magia. Las hechiceras son débiles en combate cercano. Sin embargo, su habilidad para invocar guerreros esqueleto de las tropas derrotadas puede ser decisiva en batalla.'
            },
            wisp: {
                name: 'Fragmento',
                description:
                    'Estos seres míticos de luz pura irradian un aura que aumenta las habilidades de ataque de las unidades cercanas. En combate a corta distacia son especialmente mortales contra los guerreros esqueleto.'
            },
            'dire-wolf': {
                name: 'Lobos Mortales',
                description:
                    'Los lobos mortales son feroces cazadores que viajan en manada. Ten cuidado - su mordida es venenosa y reduce los niveles de ataque y defensa por un turno.'
            },
            golem: {
                name: 'Golem',
                description:
                    'Los golem son seres antiguos - lentos pero inmensamente poderosos en defensa. Un golem posicionado en un edificio o una montaña es muy difícil de derrotar.'
            },
            catapult: {
                name: 'Catapulta',
                description:
                    'Las catapultas proclaman un rastro de destrucción con su enorme rango de ataque. Sin embargo, su relativa inmovilidad y inhabilidad para atacar a corta distancia las hace vulnerables, así que resguardalas bien. Las catapultas pueden moverse así como atacar durante un turno, pero no las dos cosas al mismo tiempo.'
            },
            dragon: {
                name: 'Dragón',
                description:
                    'Estas masivas bestias voladoras han reinado sobre las montañas de niebla desde tiempos antiguos. Son extremadamente ágiles y mortales tanto en tierra como aire y mar.'
            },
            skeleton: {
                name: 'Esqueletos',
                description:
                    'Invocados por Hechiceras, estos guerreros sin vida son tan fuertes como los soldados y mortales oponentes sobre cualquier campo de batalla.'
            },
            galamar: {
                name: 'Galamar',
                description:
                    'Galamar (comandante) es muy fuerte en ataque y defensa. Los comandantes también pueden ocupar castillos para producir tropas y pueden ser revividos en el castillo si caen en batalla.'
            },
            valadorn: {
                name: 'Valador',
                description:
                    'Valador (comandante) es muy fuerte en ataque y defensa. Los comandantes también pueden ocupar castillos para producir tropas y pueden ser revividos en el castillo si caen en batalla.'
            },
            'demon-lord': {
                name: 'Señor de los demonios',
                description:
                    'Señor de los demonios (comandante) es muy fuerte en ataque y defensa. Los comandantes también pueden ocupar castillos para producir tropas y pueden ser revividos en el castillo si caen en batalla.'
            },
            saeth: {
                name: 'Saeth',
                description:
                    'Saeth (comandante) es muy fuerte en ataque y defensa. Los comandantes también pueden ocupar castillos para producir tropas y pueden ser revividos en el castillo si caen en batalla.'
            },
            crystal: {
                name: 'Cristal',
                description:
                    'Estos legendarios cristales fueron recuperados originalmente de las ruinas de la Antigua Ciudadela. Poco se sabe de su poder, excepto que se rumora que protegen el reino, aunque también poseen el poder para destruirlo.'
            }
        },

...
(function(win) {
    ...
    win.APP.maps.skirmish_001_029 = {
        ...
        maxPlayers: 2,
        units: [
            {x: 4, y: 0, type: 'commander', ownerId: 0},
            {
                x: 3,
                y: 0,
                type: 'sorceress',
            ...
            {x: 6, y: 0, type: 'archer', ownerId: 0},
            {x: 1, y: 0, type: 'archer', ownerId: 0},
            {
                x: 7,
                y: 0,
                type: 'golem',
            ...
            {x: 0, y: 0, type: 'golem', ownerId: 0},
            {x: 0, y: 1, type: 'soldier', ownerId: 0},
            {
                x: 1,
                y: 1,
                type: 'soldier',
            ...
            {x: 6, y: 7, type: 'archer', ownerId: 1},
            {x: 1, y: 7, type: 'archer', ownerId: 1},
            {
                x: 7,
                y: 7,
                type: 'golem',
            ...
            {x: 0, y: 7, type: 'golem', ownerId: 1},
            {x: 0, y: 6, type: 'soldier', ownerId: 1},
            {
                x: 1,
                y: 6,
                type: 'soldier',
            ...
            {x: 7, y: 6, type: 'soldier', ownerId: 1}
        ],
        buildings: [
            {x: 5, y: 2, type: 'farm', state: 'destroyed'},
            {
                x: 7,
                y: 4,
                type: 'farm',

...
(function(win) {
    ...
    win.APP.maps.skirmish_001_023 = {
        ...
        maxPlayers: 2,
        units: [
            {x: 14, y: 0, type: 'commander', ownerId: 1},
            {
                x: 12,
                y: 0,
                type: 'catapult',
            ...
            {x: 0, y: 10, type: 'golem', ownerId: 0},
            {x: 0, y: 9, type: 'golem', ownerId: 0},
            {
                x: 0,
                y: 8,
                type: 'golem',
            ...
            {x: 1, y: 11, type: 'golem', ownerId: 0},
            {x: 2, y: 11, type: 'golem', ownerId: 0},
            {
                x: 3,
                y: 11,
                type: 'golem',
        ...
        buildings: [
            {x: 5, y: 2, type: 'castle', state: 'normal'},
            {
                x: 7,
                y: 5,
                type: 'castle',

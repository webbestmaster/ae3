...
(function(win) {
    ...
    var langEn = win.APP.languages.en,
        ...
        langEnExtra = {
            name: 'RENDEZVOUS',
            objective:
                'Carve a path to the west through the enemy troops, defeat their commander and occupy all castles! Galamar and Valadorn must survive.'
        },
        langRuExtra = {
            name: 'ВСТРЕЧА',
            objective:
                'Пробить путь на запад через вражеские войска, убить их командира и занять все замки! Король Галамар и Король Валадорн должны выжить.'
        },
        langEsExtra = {
            name: 'REUNIÓN',
            objective:
                'Tallar un camino hacia el oeste a través de las tropas enemigas, derrotar a su comandante y ocupar todos los castillos! Galamar y Valadorn deben sobrevivir.'
        },
        langZhExtra = {
            name: '会和',
    ...
    win.APP.maps.mission_001_007 = {
        ...
        maxPlayers: 2,
        unitLimit: 25,
        money: [{playerId: 0, money: 400}, {playerId: 1, money: 400}],

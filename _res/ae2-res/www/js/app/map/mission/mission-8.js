    ...
    win.APP.maps.mission_001_008 = {
        ...
        endBriefing: [
            ...
            },
            {
                ...
                popupData: {
                    ...
                    text:
                        'And thank you for playing AE2 - I very much hope you enjoyed playing it as much as I enjoyed making it!'
                },
                onHide: {
                    fn: 'backTo',
                    args: ['', {isForce: true}]
        ...
        'startBriefing-es': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        '¡Al fin, Galamar y Valador! ¡Vaya si son valientes para atreverse a enfrentarme! Todas las llaves están colocadas, y pronto el mas grande poder que se jámas se haya creado en la tierra rugirá y se doblara a mi voluntad. ¡Tu destrucción será el testimonio de su poder y gloria!',
                    img: 'i/face/saeth.png'
                },
                onShow: {
                    fn: 'centerToXY',
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Patéticas criaturas, ¡Ésto es algo tan antiguo que no lo comprenderían ni aunque vivieran mil años! ¡Testifiquen el poder de la Furia de los Cielos!',
                    img: 'i/face/saeth.png'
                },
                onShow: {
                    fn: 'centerToXY',
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Señor, deberiamos atacar esos castillos primero antes de lanzar un ataque a las Ruinas donde está Saeth',
                    img: 'i/face/soldier.png'
                }
            },
            {
        ...
        'endBriefing-es': [
            {
                ...
                popupData: {
                    text:
                        'Lamentables y miserables. Ustedes no vivirán lo suficiente para ver su precioso reino envuelto en oscuridad...',
                    img: 'i/face/saeth.png'
                }
            },
            {
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'En sus insignificantes vidas y estrechas mentes, quizás... Sin embargo todo esta ahora puesto en marcha - Las invisibles fuerzas que goviernan el tiempo están más allá de su compresión. ¡No pueden evitar que me levante de nuevo!',
                    img: 'i/face/saeth.png'
                }
            },
            {
            ...
            },
            {
                ...
                popupData: {
                    ...
                    text:
                        'Gracias por jugar AE2 - ¡Espero que hayas disfrutado jugando, tanto como yo disfrute haciendolo!'
                },
                onHide: {
                    fn: 'backTo',
                    args: ['', {isForce: true}]
        ...
        'startBriefing-ru': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Наконец-то, Галамар и Валадорн! Как вы храбры, чтобы противостоять мне! Все ключи на местах, и скоро величайшая сила из свех, когда либо созранных на земле подчинится моей воле. Ваше уничтожение будет доказательством этой силы!',
                    img: 'i/face/saeth.png'
                },
                onShow: {
                    fn: 'centerToXY',
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Жалкие создания, это что-то настолько древнее, чего вы не сможете понять, даже если проживете тысячи лет! Будьте свидетелями силы Небесной ярости!',
                    img: 'i/face/saeth.png'
                },
                onShow: {
                    fn: 'centerToXY',
        ...
        'endBriefing-ru': [
            {
                ...
                popupData: {
                    text:
                        'Жалкие негодяи! Вы не проживете столько, чтобы увидеть, как ваше драгоценное Королевство поглотиться тьмой...',
                    img: 'i/face/saeth.png'
                }
            },
            {
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'В твоей незначительной жизни и ограниченных мозгах, возможно...Тем не менее все сейчас в движении - невидимые силы, которые управляют временем за пределами твоих знаний. Ты не сможешь остановить меня от воскрешения!',
                    img: 'i/face/saeth.png'
                }
            },
            {
            ...
            },
            {
                ...
                popupData: {
                    ...
                    text:
                        "И благодарим вас за игру в 'Ancient Empire: Strike Back' - я очень надеюсь, что вы насладились игрой также как я наслаждался, создавая ее!"
                },
                onHide: {
                    fn: 'backTo',
                    args: ['', {isForce: true}]
        ...
        'startBriefing-zh': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        '结束了，格拉玛与渥拉顿。你们真是太可笑了，居然想要对抗我！水晶的力量已经聚齐，现在我掌握了最强大的力量！我的意愿就是神的意志！来看看我是如何摧毁你们的吧！',
                    img: 'i/face/saeth.png'
                },
                onShow: {
                    fn: 'centerToXY',

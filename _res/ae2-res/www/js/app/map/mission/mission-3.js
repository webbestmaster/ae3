...
(function(win) {
    ...
    var langEn = win.APP.languages.en,
        ...
        langEsExtra = {
            ...
            objective:
                'Pasa através del bosque con seguridad. Destruye toda resistencia. El rey Galamar debe sobrevivir.'
        },
        langZhExtra = {
            name: '阴影之路',
    ...
    win.APP.maps.mission_001_003 = {
        ...
        'startBriefing-es': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Su Majestad, este bosque es conocido por ser el hogar de espíritus, Elementales, y otras mágicas criaturas. No es seguro viajar de noche.',
                    img: 'i/face/soldier.png'
                },
                onShow: {
                    fn: 'centerToXY',
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Capitán, escuchó al mensajero de Valador - ¡Debemos avanzar! Nada puede detenernos para llegar a El Templo de la Vida.',
                    img: 'i/face/galamar.png'
                }
            },
            {
        ...
        'n1Briefing-es': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        '¡Saludos, hombres de Thorin! Nosotros, Los Elementales, hemos oido acerca de su búsqueda para proteger nuestras tierras de la maldad y les ofrecemos nuestra alianza a su Rey.'
                },
                onShow: {
                    fn: 'centerToXY',
                    context: 'parentView',
        ...
        'startBriefing-ru': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Ваше величество, лес известен как обитель духов, элементалов, и других магических созданий. Путешествовать по нему ночью небезопасно.',
                    img: 'i/face/soldier.png'
                },
                onShow: {
                    fn: 'centerToXY',
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Капитан, вы слышали посланника от Валадорна - мы должны поднажать! Ничего не должно стоять между нами и Храмом Жизни.',
                    img: 'i/face/galamar.png'
                }
            },
            {
        ...
        'n1Briefing-ru': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Здраствуйте, люди Торина! Мы, Элементалы, слышали  о вашем задании по защите наших земель от зла, и предлагаем нашу верность нашему Королю.'
                },
                onShow: {
                    fn: 'centerToXY',
                    context: 'parentView',
        ...
        buildings: [{x: 4, y: 8, type: 'well', state: 'normal'}],
        terrain: {
            x0y0: 'forest-1',
            x0y1: 'forest-1',
            x0y2: 'stone-1',

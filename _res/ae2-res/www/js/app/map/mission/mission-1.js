...
(function(win) {
    ...
    win.APP.maps.mission_001_001 = {
        ...
        help: [langEn.helpList[0], langEn.helpList[1]],
        startBriefing: [
            {
                popupName: 'story',
        ...
        'help-es': [langEs.helpList[0], langEs.helpList[1]],
        'startBriefing-es': [
            {
                popupName: 'story',
                cssClass: 'full-screen',
            ...
            },
            {
                ...
                popupData: {
                    text:
                        '¡Ayúdennos! ¡Estamos bajo ataque! ¡Estos esqueletos invasores han robado el Cristal del Coraje que juramos protejer!',
                    img: 'i/face/tamplier.png'
                }
            },
            {
        ...
        'endBriefing-es': [
            {
                ...
                popupData: {
                    text:
                        'Le agradesco, su majestad, tiene que ayudarnos a recuperar el Cristal lo mas pronto posible. ¡Una reliquía tan importante no debe caer en las manos equivocadas!',
                    img: 'i/face/tamplier.png'
                }
            },
            {
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Temo que estos criminales puedan estar aliados con un mal mayor. Sería prudente consultarlo con el sumo sacerdote en el Templo de la Sabiduría. Puede que él sepa más acerca de esto.',
                    img: 'i/face/tamplier.png'
                }
            },
            {
                ...
                popupData: {
                    text:
                        'Enviare a mi hermano Valador inmediatamente. Tomaré mis tropas y siguiré a los atacantes que escaparon.',
                    img: 'i/face/galamar.png'
                }
            },
            {
        ...
        'help-ru': [langRu.helpList[0], langRu.helpList[1]],
        'startBriefing-ru': [
            {
                popupName: 'story',
                cssClass: 'full-screen',
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Помогите! Нас атакуют! Эти скелеты-налетчики украли Кристалл Отваги, который мы поклялись защищать!',
                    img: 'i/face/tamplier.png'
                }
            },
            {
        ...
        'endBriefing-ru': [
            {
                ...
                popupData: {
                    text:
                        'Благодарю, ваше Величество, вы должны помочь нам возвратить Кристалл как можно быстрее. Такая важная реликвия не должна попасть в плохие руки!',
                    img: 'i/face/tamplier.png'
                }
            },
            {
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Боюсь, эти злоумышленники могут быть связаны с еще большим злом. Было бы умно посоветоваться с Высщим Священником из Храма Мудрости. Он может знать больше об этом.',
                    img: 'i/face/tamplier.png'
                }
            },
            {
        ...
        'help-zh': [langZh.helpList[0], langZh.helpList[1]],
        'startBriefing-zh': [
            {
                popupName: 'story',
                cssClass: 'full-screen',

...
(function(win) {
    ...
    win.APP.maps.mission_001_002 = {
        ...
        money: [{playerId: 0, money: 300}, {playerId: 1, money: 300}],
        ...
        help: [langEn.helpList[2], langEn.helpList[3]],
        startBriefing: [
            {
        ...
        'help-es': [langEs.helpList[2], langEs.helpList[3]],
        'startBriefing-es': [
            {
                popupName: 'simple-notification',
                popupData: {
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Detengamos el ataque primero. De otra manera los guardias del templo no tendrán oportunidad!',
                    img: 'i/face/valadorn.png'
                },
                onShow: {
                    fn: 'centerToXY',
        ...
        'endBriefing-es': [
            {
                ...
                popupData: {
                    text:
                        'Bien hecho Capitán. Pero no hay tiempo para descansar. El Cristal de la VIda puede estar en peligro. ¡Debemos advertir al rey Galamar!',
                    img: 'i/face/valadorn.png'
                }
            },
            {
        ...
        'help-ru': [langRu.helpList[2], langRu.helpList[3]],
        'startBriefing-ru': [
            {
                popupName: 'simple-notification',
                popupData: {
        ...
        'endBriefing-ru': [
            {
                ...
                popupData: {
                    text:
                        'Хорошая работа, Капитан. Но у нас нет времени на отдых. Кристалл Жизни все еще в опасности. Мы должны предупредить Короля Галамара!',
                    img: 'i/face/valadorn.png'
                }
            },
            {
        ...
        'help-zh': [langZh.helpList[2], langZh.helpList[3]],
        'startBriefing-zh': [
            {
                popupName: 'simple-notification',
                popupData: {
        ...
        'endBriefing-zh': [
            {
                ...
                popupData: {
                    text:
                        '做得好！长官！但是恐怕我们没有时间休息了，生命水晶可能也有危险，我们必须赶紧通知国王格拉玛！',
                    img: 'i/face/valadorn.png'
                }
            },
            {

...
(function(win) {
    ...
    win.APP.maps.mission_001_006 = {
        ...
        maxPlayers: 2,
        unitLimit: 25,
        money: [{playerId: 0, money: 600}, {playerId: 1, money: 600}],
        ...
        'startBriefing-es': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        '¡El enemigo está planeando atacar al Rey Galamar antes de que alcanze Thorin! ¡Tenemos que derrotarlos!',
                    img: 'i/face/valadorn.png'
                },
                onShow: {
                    fn: 'centerToXY',
        ...
        'endBriefing-es': [
            {
                ...
                popupData: {
                    text:
                        'Dirijamonos hacia el Norte para encontrarnos con Galamar. ¡Las tropas enemigas conocen sobre sus planes y puede que necesite ayuda!',
                    img: 'i/face/valadorn.png'
                }
            },
            {
        ...
        'startBriefing-ru': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Враг планирует атаковать Короля Галамара, пока он не достигнет Торина. Мы должны уничтожить их!',
                    img: 'i/face/valadorn.png'
                },
                onShow: {
                    fn: 'centerToXY',
        ...
        'endBriefing-ru': [
            {
                ...
                popupData: {
                    text:
                        'Давайте поспешим на Север, чтобы встретиться с Галамаром. Враги знают о его планах и ему может потребоваться наша помощь!',
                    img: 'i/face/valadorn.png'
                }
            },
            {

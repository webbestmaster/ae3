...
(function(win) {
    ...
    var langEn = win.APP.languages.en,
        ...
        langEsExtra = {
            name: 'REFUERZOS',
            objective:
                'Proteje el Templo de la Vida - ¡Destruye a todas las unidades enemigas, ocupa el castillo enemigo! '
        },
        langZhExtra = {
            name: '筋',
    ...
    win.APP.maps.mission_001_004 = {
        ...
        'startBriefing-es': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        '¡Están destruyendo nuestros edificios para mermar nuestro suministro de oro! ¡Deben ser detenidos!',
                    img: 'i/face/soldier.png'
                }
            },
            {
        ...
        'startBriefing-ru': [
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Только в хорошо защищенных крепостях Торина Кристалл будет в безопасности. Мы должны принести его туда.',
                    img: 'i/face/galamar.png'
                }
            },
            {
            ...
            },
            {
                ...
                popupData: {
                    text:
                        'Они разрушают наши здания, чтобы нанести ущерб нашим поставкам золота! Она должны быть остановлены!',
                    img: 'i/face/soldier.png'
                }
            },
            {
